...
const Profile = () => {
    ...
    if (isAuthenticated) {
        var { name, picture, email } = user;
        return (<div className='w-full'><div className="relative max-w-md mx-auto md:max-w-2xl mt-6 min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-xl mt-16">
            <div className="px-6">
                <div className="flex flex-wrap justify-center">
                    <div className="w-full flex justify-center">
                        <div className="relative">
                            <img src={picture} className="shadow-xl rounded-full align-middle border-none absolute -m-16 -ml-20 lg:-ml-16 max-w-[150px]" />
                        </div>
                    </div>
        ...
        return (
            <div className='inline-block content-center w-full m-[150px]'>
                <p className='text-4xl'>Login or sign up to view your profile</p>
            </div>
        )
    }
}
