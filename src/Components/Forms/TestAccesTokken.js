...
const TestAccesTokken = () => {
    ...
    const callSecureApi = async () => {
        try {
            ...
            const response = await fetch(`${serverUrl}/api/User/GetFollowers`,
                {
                    headers: {
                        Authorization: `${token}`,
                    },
            ...
            {message && (
                <div className="mt-5">
                    ...
                    <div className="container-fluid">
                        <div className="">
                            <code className="col-12 text-light bg-gray-500 p-4">{message}</code>
                        </div>
                    </div>
                </div>
            )}
...
export default TestAccesTokken;